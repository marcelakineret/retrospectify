...
export default {
  ...
  bind: function(el, binding, vNode) {
    ...
    let fn = vNode.context[binding.expression];
    ...
    let fnStart = vNode.context[binding.expression + "Start"];
    if (typeof fnStart === "function") {
      el.callbackStart = fnStart;
    }

    let fnStop = vNode.context[binding.expression + "Stop"];
